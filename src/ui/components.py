...
def render_weather_widget():
    """Affiche un petit widget météo et heure."""
    ...
    st.markdown(f"""
    <div style="display: flex; justify-content: space-between; padding: 10px 20px; color: #6b7280; font-size: 0.9em; font-weight: 600;">
        <span>🇳🇪 Niamey</span>
